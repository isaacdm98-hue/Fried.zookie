...
var DATA = (function () {
  ...
  var PLANET_IN_HOUSE = {
    // Each entry: three short lines, written TO the person about their life — second person, modern
    // words, one thought per line. The content is still Lilly's house chapters and Morin's
    // determinations; only the diction moved three centuries. Line one names the placement, so every
    // entry opens anchored to this chart.
    sun: [
      ['With your Sun in your 1st, you lead with yourself: people notice you before you speak.', 'You need to run your own life — following someone else’s plan drains you fast.', 'Pride is your fuel, and occasionally your blind spot.'],
      ['With your Sun in your 2nd, earning your own money is identity, not just survival.', 'Being broke hits your confidence harder than it hits most people.', 'Income tends to come through senior people and being trusted with real responsibility.'],
      ['With your Sun in your 3rd, you shine in the everyday: talking, writing, connecting people.', 'Being the sharp one among siblings, neighbours and colleagues matters to you.', 'Short trips, messages and local business carry more of your life than you’d expect.'],
      ['With your Sun in your 4th, your father — present or absent — shaped more than you may admit.', 'You come into your own later than your peers, and at home before in public.', 'Property, family and where you’re from stay central to who you are.'],
      ['With your Sun in your 5th, you’re at your best when you’re making something.', 'Romance, children and creative work are where your pride lives.', 'You have real luck in performance and play — and you know it.'],
      ['With your Sun in your 6th, you take charge of the daily work rather than submit to it.', 'Colleagues tend to fall in behind you; you set the standard.', 'Your vitality is real but wants guarding — heart and stamina are where health asks attention.'],
      ['With your Sun in your 7th, other people are your arena: you find yourself through partners and rivals.', 'You’re drawn to partners with standing — and sometimes to opponents with it.', 'The big matches of your life, in love and in conflict, define you more than solo wins.'],
      ['With your Sun in your 8th, you face what others avoid: debts, endings, other people’s money.', 'You gain where things are handed over — inheritance, shared assets, what people leave behind.', 'Fear doesn’t run you; you look at hard things straight.'],
      ['With your Sun in your 9th, your life gets bigger the further you go from where it started.', 'Recognition comes through study, travel, publishing or belief.', 'What you believe isn’t private — you stand up in it.'],
      ['With your Sun in your 10th, you were built to be seen: career and reputation are the main stage.', 'You climb, and you usually get there — titles and standing genuinely matter to you.', 'Your name is the currency; kept clean, it pays for decades.'],
      ['With your Sun in your 11th, you rise through people: friends and allies open your doors.', 'The powerful tend to like you, and their favour carries further than solo effort.', 'What you hope for tends to arrive — through the circle you keep.'],
      ['With your Sun in your 12th, you do your best work out of sight.', 'Credit often lands on someone else, and recognition comes late or behind closed doors.', 'You need real solitude to stay well — and your opposition rarely shows its face openly.']
    ],
    moon: [
      ['With your Moon in your 1st, your feelings show on your face whether you like it or not.', 'People warm to you without quite knowing why.', 'Your moods and energy move in tides — no two days quite the same.'],
      ['With your Moon in your 2nd, money comes and goes like weather.', 'You earn through the public: people, service, demand that shifts.', 'Financial security is emotional security for you; a thin account keeps you up at night.'],
      ['With your Moon in your 3rd, your mind never idles: messages, errands and news fill the days.', 'You think by feeling, and you say it as you feel it.', 'Siblings and neighbours sit close to the centre of your life.'],
      ['With your Moon in your 4th, home is your anchor — and your recurring question.', 'Your mother runs deep in your story, for good and for ill.', 'You move house more than most, yet the past stays close enough to touch.'],
      ['With your Moon in your 5th, your feelings pour into romance, children and what you make.', 'You’re a fond, protective parent — of children and of projects alike.', 'Pleasure comes in waves, and there’s usually an audience nearby.'],
      ['With your Moon in your 6th, your body keeps the score of your routines.', 'Stomach, sleep and habits answer directly to your mood.', 'Your work serves the public, and your routine changes as often as your feelings do.'],
      ['With your Moon in your 7th, you meet partners in public — or they belong to it.', 'You’re drawn to changeable, popular people.', 'In your closest bonds, the crowd is somewhere in the room.'],
      ['With your Moon in your 8th, you feel losses in your body before your mind admits them.', 'Money arrives through others: inheritance, shared accounts, often through women.', 'Your fears come and go like tides — they pass if you let them.'],
      ['With your Moon in your 9th, you’re restless far from home yet fed by going.', 'Your beliefs wander and grow; journeys multiply.', 'Water and foreign places pull you harder than logic explains.'],
      ['With your Moon in your 10th, your career is lived in front of people.', 'Your reputation rises and falls with public mood — and recovers.', 'Your mother stands behind your ambition, and you don’t rest until the work is seen.'],
      ['With your Moon in your 11th, friends arrive in numbers — women and ordinary people above all.', 'Your hopes ride the crowd’s favour: warm one season, thin the next.', 'You feel best when the circle is full.'],
      ['With your Moon in your 12th, private sorrows come and go without visible cause.', 'Retreat restores what company drains.', 'Hospitals, water and the quiet places recur in your story more than in most lives.']
    ],
    mercury: [
      ['With Mercury in your 1st, your mind is the first thing people meet.', 'You stay young in manner whatever your age.', 'You are what you know: an identity built of words and wit.'],
      ['With Mercury in your 2nd, you earn by wit — words, trade, numbers, deals.', 'Money moves fast in both directions with you.', 'Your best asset is literally your ability to explain things.'],
      ['With Mercury in your 3rd, your mind sits in its own home: quick, hungry, everywhere.', 'Letters, siblings, learning and short trips fill your life.', 'The risk was never dullness — it’s restlessness.'],
      ['With Mercury in your 4th, your sharpest thinking happens at the kitchen table, not the office.', 'Family papers, history and roots pull your mind homeward.', 'You study best in private.'],
      ['With Mercury in your 5th, you flirt in words first.', 'Teaching, games and writing for pleasure suit you.', 'Wit is how you play — and your children, if they come, are quick.'],
      ['With Mercury in your 6th, you have real skill with detail: craft, systems, the work itself.', 'You’re exacting, and so is the job.', 'Your nerves keep the account when worry runs long.'],
      ['With Mercury in your 7th, partnership is a conversation or it’s nothing.', 'You’re drawn to clever, younger or bookish partners.', 'Disputes get argued — brilliantly — rather than dropped.'],
      ['With Mercury in your 8th, your mind goes where others look away: debts, secrets, the machinery underneath.', 'You’re a born investigator.', 'Taxes, contracts and other people’s money reward your attention.'],
      ['With Mercury in your 9th, your questions are big and your mind goes the distance.', 'Law, languages, publishing and long study suit you.', 'Travel isn’t escape for you — it’s research.'],
      ['With Mercury in your 10th, your career runs on your mind: writing, trade, teaching, counsel.', 'Your reputation is for being clever, and it’s earned.', 'Your words are your public face, and they carry further than you think.'],
      ['With Mercury in your 11th, your friends are the young and the sharp.', 'Plans advance through advice, contacts and the right word in the right ear.', 'You collect useful people the way others collect things.'],
      ['With Mercury in your 12th, your mind works best unseen — and doubts itself in public.', 'You keep more back than anyone knows.', 'Your nerves pay for what stays unsaid; solitude and writing settle them.']
    ],
    venus: [
      ['With Venus in your 1st, charm is the first thing people meet in you.', 'Doors open for you that others have to knock on.', 'Life bends toward ease, affection and beauty when you’re in the room.'],
      ['With Venus in your 2nd, money arrives pleasantly: through art, taste, and people who like you.', 'Earning rarely feels like combat for you.', 'You spend on beauty, and mostly don’t regret it.'],
      ['With Venus in your 3rd, kindness lives in your everyday: warm siblings, friendly neighbours, sweet words.', 'Even your errands tend to be pleasant.', 'You keep the peace in the near world, and it keeps you.'],
      ['With Venus in your 4th, a beautiful home matters to you — and usually happens.', 'Your roots are happy, or you make them so.', 'The mother and property both tend to pay you, and later life runs soft.'],
      ['With Venus in your 5th, love is your home ground: romance, children, art and pleasure all flourish.', 'Being a lover is something you’re genuinely good at.', 'What you make for joy tends to be beautiful.'],
      ['With Venus in your 6th, affection flows into the working day.', 'You’re loved where you work, and pleasure hides inside service itself.', 'Throat and kidneys are the body’s soft points.'],
      ['With Venus in your 7th, marriage is often the making of your life.', 'You draw desirable, sociable partners.', 'Union, when it comes, comes as a gift rather than a project.'],
      ['With Venus in your 8th, love and loss sit close together for you.', 'Marriage, legacies and what others share with you tend to pay.', 'Your desire runs deep and a little hidden — pleasure with a deep end.'],
      ['With Venus in your 9th, love has a foreign or philosophical flavour.', 'You find beauty far afield: in faith, in art, in travel.', 'Harmony comes easier abroad.'],
      ['With Venus in your 10th, your reputation is graceful.', 'Art, taste and people’s genuine liking for you carry you upward.', 'Patrons enjoy helping you — a career asset most people don’t have.'],
      ['With Venus in your 11th, your friends love you and actually help.', 'Your hopes are met sweetly, often through women.', 'Your circle is genuinely fortunate — one of this chart’s quiet gifts.'],
      ['With Venus in your 12th, you keep love in the drawer: private affections, quiet pleasures.', 'Your kindness is done unseen.', 'Sorrow through love stays untold — and costs more for it.']
    ],
    mars: [
      ['With Mars in your 1st, your drive sits on the surface: bold, fast, met head on.', 'You often carry a scar that tells its own story.', 'You take hits as readily as you give them — the temper is the tax.'],
      ['With Mars in your 2nd, you fight for money, win it fast and spend it faster.', 'You earn through effort, tools and hard work.', 'Wealth burns unless it’s banked.'],
      ['With Mars in your 3rd, your tongue is a blade.', 'Quarrels with siblings and neighbours flare fast — so do bold plans.', 'The road taxes your daring: accidents ride with haste.'],
      ['With Mars in your 4th, the friction starts at home: with the father, over the ground itself.', 'Family property gets fought over unless this heat is held well.', 'You defend your own fiercely — that is the gift inside it.'],
      ['With Mars in your 5th, passion runs your pleasures.', 'You’re reckless in love and speculation, alive to sport and daring.', 'Children bring risk and fierce pride at once.'],
      ['With Mars in your 6th, you have real skill with tools, force and the hard trades.', 'Fevers and inflammations are your body’s tax.', 'Workmates strike sparks off you: heat is part of your working day.'],
      ['With Mars in your 7th, your partner brings heat — passion and conflict in the same person.', 'Rivals declare themselves openly.', 'You fight rather than settle, and sometimes that costs more than losing would.'],
      ['With Mars in your 8th, the deep matters are contested: shared money, legacies, endings.', 'You have courage exactly where others fear.', 'Sudden loss is the standing risk here when help stands far away.'],
      ['With Mars in your 9th, you fight for what you believe.', 'Your calling may march abroad; long roads carry danger and glory both.', 'Zeal turns to conflict when nobody is watching it.'],
      ['With Mars in your 10th, your career is a campaign.', 'Command, competition, sharp tools: you drive hard, and the name is won by force.', 'What force wins, force can risk — the summit needs holding.'],
      ['With Mars in your 11th, your friends are the bold: fighters, competitors, the daring.', 'You pursue your hopes by force.', 'False or fiery friends are the standing risk in the circle.'],
      ['With Mars in your 12th, your anger works underground.', 'What stays unexpressed turns into self-sabotage.', 'Your enemies don’t announce themselves — and neither does your own temper.']
    ],
    jupiter: [
      ['With Jupiter in your 1st, generosity is your bearing: people like you, and luck finds you.', 'You’re hopeful by default, and it mostly pays.', 'Excess is the only real enemy here.'],
      ['With Jupiter in your 2nd, money comes easily and honourably.', 'You earn through law, faith, and people of standing.', 'Your purse trusts life, and life mostly repays it.'],
      ['With Jupiter in your 3rd, good fortune lives in your near world.', 'Warm siblings, helpful neighbours, lucky short trips.', 'Your everyday mind is broad and principled.'],
      ['With Jupiter in your 4th, your home ground is blessed: fortune flows from family and inheritance.', 'The father tends to help rather than hinder.', 'The end of the matter — and of the life — runs comfortable.'],
      ['With Jupiter in your 5th, you have luck as a lover and as a parent.', 'Children are many or fortunate; pleasure pays instead of costing.', 'Generosity comes back to you as joy.'],
      ['With Jupiter in your 6th, your health mends fast and your work is blessed.', 'Gain comes by service, medicine or law.', 'You’re kind to the people who work for you, and it returns.'],
      ['With Jupiter in your 7th, marriage brings fortune.', 'Your partner is generous, and your contracts hold.', 'Open dealing turns out well for you: honesty is literally profitable.'],
      ['With Jupiter in your 8th, you gain where others lose.', 'Legacies, marriage portions and shared money come well managed.', 'The deep matters pass more easily for you than for most.'],
      ['With Jupiter in your 9th, this is its best seat: faith, law, learning and travel all flourish.', 'Recognition comes from abroad or from study.', 'Your beliefs are broad and humane.'],
      ['With Jupiter in your 10th, honour and preferment come to you.', 'Promotion seeks you out.', 'Principle and patronage carry your success.'],
      ['With Jupiter in your 11th, your friends are powerful and they help.', 'Patrons open doors.', 'Your hopes are generously met — the circle lifts you.'],
      ['With Jupiter in your 12th, your luck works quietly.', 'Help arrives from nowhere at the worst moments.', 'Good done unseen returns; over-trust is the hidden tax.']
    ],
    saturn: [
      ['With Saturn in your 1st, your start was slow and your manner grave.', 'Self-doubt walks in front of you — and behind it, real endurance.', 'Your life blooms late, but it blooms solid.'],
      ['With Saturn in your 2nd, money comes slowly and by labour.', 'Your fear of want runs beyond the facts.', 'What you finally build, holds: land, patience and age all pay you.'],
      ['With Saturn in your 3rd, weight sits in the near world: duty or distance with siblings.', 'Your everyday mind is careful and sombre.', 'Short journeys are work, not pleasure.'],
      ['With Saturn in your 4th, you carry the family’s weight.', 'Home, father and property bind as much as they shelter.', 'Your ground is earned, not given — and you do earn it.'],
      ['With Saturn in your 5th, joy is rationed: children few, late, or heavy with responsibility.', 'You’re cautious where others play.', 'Pleasure has to be scheduled to happen at all.'],
      ['With Saturn in your 6th, your work is hard, unglamorous, and gets done.', 'Cold, chronic complaints tax the body.', 'Endurance turns out to be your actual skill.'],
      ['With Saturn in your 7th, marriage comes late, dutiful, or to someone older and graver.', 'It endures where lighter matches fail — but it weighs.', 'Enemies made in partnership last.'],
      ['With Saturn in your 8th, the deep matters move slowly: legacies delayed, endings long.', 'You carry a quiet fear of endings.', 'Gain comes eventually — by the dead, by land, by patience with loss.'],
      ['With Saturn in your 9th, your faith is serious business: doubting or orthodox, never casual.', 'Long journeys are hard and formative.', 'Your wisdom is earned by trial, not granted.'],
      ['With Saturn in your 10th, the climb is slow and the fall, if it comes, is hard.', 'Authority arrives by endurance; your reputation is for gravity.', 'You reach the summit late — and hold it.'],
      ['With Saturn in your 11th, your friends are few but lasting, often older.', 'Hopes are deferred and won by patience.', 'You carry duty in the circle, and you carry it faithfully.'],
      ['With Saturn in your 12th, old sorrows keep their own room.', 'Confinement, hidden fears and slow enemies are the terrain.', 'Solitude is first a sentence, then — slowly — a teacher.']
    ]
  };
