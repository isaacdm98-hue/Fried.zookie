...
var DATA = (function () {
  ...
  var PLANET_IN_HOUSE = {
    sun: [
      'a presence people notice before you speak; the life runs in your own name and on your own vitality, and pride is both the engine and the thing that can drive it off the road',
      'earning is a matter of pride, not just need; money comes through position and the people above you, and the purse opens whenever being seen well is at stake',
      'the voice that carries in the family and the street; standing among siblings and neighbours matters, and even the short journeys serve advancement',
      'the father stands large in the story, for good or ill; honour arrives late, through family, property or the land, and the second half of life outshines the first',
      'children, romance and what you create carry your pride; there is real luck in pleasure and performance, and a strong pull toward the stage, the game, the grand gesture',
      'authority shows in the daily work: you run the routine rather than submit to it, and the heart and vitality are where health asks watching',
      'you marry, or contend with, people of standing; the partner shines or competes, and the great matches and the great rivalries of the life both walk through this door',
      'the heavy matters, death, debt and inheritance, are faced in the open rather than avoided; fear is met head on, and there is gain where other people leave things behind',
      'the life brightens far from where it started; honour comes through learning, faith, publishing or abroad, and belief is something to stand up in, not keep private',
      'the classic seat of honour: the life climbs toward office, command and a public name, and usually gets there; what you do is seen, and reputation is the real currency',
      'the powerful become friends and the friends become doors; hopes are met through patrons and circles, and what you reach is reached through who stands with you',
      'the shine of this life happens off stage: honour hidden, delayed or credited to others, influence worked from behind the scenes, and opposition that never quite shows its face'
    ],
    moon: [
      'moods sit on the surface where everyone can see them; the public warms to you without quite knowing why, and body and spirits move in tides, never the same two days running',
      'money ebbs and flows like weather; income comes through the public, through women, or across water, and never sits still long enough to be counted',
      'the mind never idles: errands, messages, siblings and neighbours fill the days, and feeling and thinking are the same act done at speed',
      'home is the anchor and the question at once; the mother runs deep in the story, the address changes more often than most people’s, and the past stays close enough to touch',
      'feeling pours into children, romance and what you make; a fond, protective parent, with pleasures that come in waves and an audience never far away',
      'the body keeps the score of the daily grind: stomach and habits answer directly to mood, the work serves the public, and the routine changes as often as the feelings do',
      'the partner is met in public or belongs to it; the pull is toward changeable, popular people, and marriage has the crowd somewhere in the room',
      'losses are felt in the body before the mind admits them; legacies and shared money arrive through women or the mother, and fears come and go like tides',
      'restless far from home yet fed by going; belief wanders, journeys multiply, and water and foreign places pull harder than logic explains',
      'the career is lived in front of people, and the name rises and falls with public mood; the mother stands behind the ambition, and there is no rest until the work is seen',
      'friends arrive in numbers, women and ordinary people above all; hopes ride the crowd’s changing favour, warm one season and thin the next',
      'private sorrows come and go without visible cause; retreat restores what company drains, and hospitals, water and the quiet places recur in the story'
    ],
    mercury: [
      'the mind is the face you lead with: quick, curious, young in manner whatever the age, and identity built out of words, wit and what you know',
      'money is made by wit: trade, writing, reckoning and the tongue earn it, and it moves fast in both directions',
      'this is Mercury’s own seat: letters, siblings, learning and short trips fill the life, and the mind stays busy to the point of restlessness',
      'the mind turns homeward: family papers, records, ancestry and private study; the sharpest thinking happens at the kitchen table, not the office',
      'wit at play: teaching, games and writing for pleasure; children are clever or few, and romance is conducted in words first',
      'real skill with detail, craft, medicine or systems; the work is exacting and so are you, and the nerves keep the account when worry runs long',
      'partnership is a conversation or it is nothing: a clever, younger or bookish spouse, business built on contracts, and disputes that are argued brilliantly rather than dropped',
      'the mind is drawn to what others look away from: taxes, debts, secrets, research, the machinery underneath things; a born investigator',
      'the scholar’s seat: law, languages, publishing, long study and far travel; the questions are big and the mind goes the distance to answer them',
      'the career runs on the mind: writing, trade, teaching, agency, counsel; the reputation is for cleverness, and it is earned',
      'friends are found among the young and sharp; plans advance by advice, contacts and the right word in the right ear',
      'the mind works best unseen and doubts itself in public; study happens in solitude, much is kept back, and the nerves pay for what stays unsaid'
    ],
    venus: [
      'charm is the first thing people meet; life inclines toward ease, affection and beauty, and doors open that others have to knock on',
      'money arrives by pleasant means: through art, through women, through the things people pay to enjoy; earning rarely feels like fighting',
      'sweetness in the near world: affectionate siblings, friendly neighbours, kind words, and short journeys taken for pleasure as much as need',
      'a beautiful home matters and usually happens; roots are happy or are made so, there is gain through the mother and through property, and later life runs soft',
      'the house of joy with the planet of love in it: romance, children, art and pleasure all flourish, and being a lover is something you are genuinely good at',
      'affection flows into the working day: beloved colleagues, pleasure taken in service and in small animals, with the throat and kidneys the body’s soft points',
      'a favoured marriage that is often the making of the life; the partner is desirable and sociable, and union, when it comes, comes as a gift rather than a project',
      'love and loss sit close together: gain by marriage, dowry and legacy, desire drawn to the intense and the hidden, pleasure with a deep end',
      'beauty is found far afield: in faith, in art, in travel; love has a foreign or philosophical flavour, and harmony comes easier abroad',
      'the reputation is graceful: honour won by art, by pleasing manners and by women’s favour, and patrons who enjoy helping',
      'friends who love and actually help; hopes met sweetly, often through women, and a circle that is genuinely fortunate',
      'love kept in the drawer: secret affection, private pleasures, kindness done unseen, and sorrows through women or indulgence that no one is told about'
    ],
    mars: [
      'the drive sits on the surface: bold, quick-tempered, met head on; often a scar or mark that tells its own story, and hurt taken as readily as given',
      'money is fought for, won fast and spent faster; gain comes by iron, fire, tools or hard labour, and wealth burns unless it is banked',
      'the tongue is a blade: quarrels with siblings and neighbours, a combative daily mind, and journeys taken boldly with accidents on the road as the tax',
      'strife at the root: friction in the home and with the father, fire a literal risk to the house, and the family ground fought over unless this planet is well held',
      'passion runs the pleasures: reckless in love and speculation, alive to sport and daring, with children a field of risk and pride at once',
      'real skill with iron and fire: surgery, tools, arms, the hard trades; fevers and inflammations tax the body, and the people who work alongside strike sparks',
      'the partner brings heat: passion and conflict in the same person, rivals who declare themselves openly, and disputes fought rather than settled',
      'the deep matters are contested: strife over legacies and shared money, sudden loss a danger unless well helped, and courage in exactly the places others fear',
      'belief is fought for: a crusading faith or a calling that marches abroad, danger on long roads, and zeal that turns to conflict when nobody is watching it',
      'the career is a campaign: arms, tools, surgery, command; ambition drives hard, and the name is won by force and can be risked the same way',
      'friends among the bold: soldiers, competitors, the daring; hopes are pursued by force, and false or fiery friends are the standing risk',
      'anger works underground here: hidden enemies, self-sabotage through what stays unexpressed, and secret work with fire or blades; the danger in this house never announces itself'
    ],
    jupiter: [
      'generosity is the bearing: well liked, hopeful, expansive, lucky in ways that are hard to itemise, with excess the only real enemy',
      'wealth comes easily and honourably: through law, faith and trade with people of standing; the purse trusts life, and life mostly repays it',
      'good fortune in the near world: warm siblings, helpful neighbours, lucky short journeys, and a broad, principled everyday mind',
      'a prosperous home and good ground: fortune flows from the father and from inheritance, and the end of the matter, and of the life, is comfortable',
      'luck as a lover and as a parent: many or fortunate children, gain by pleasure and honest speculation, and generosity repaid in joy',
      'health mends fast and the work is blessed: gain by service, medicine or law, kindness toward those who serve, and a working day that grows',
      'a fortunate, honourable marriage: a generous partner, contracts that hold, and open dealings that turn out well',
      'gain where others lose: marriage portions, legacies, other people’s wealth managed honourably, and an easier passage than most through the deep matters',
      'Jupiter’s best seat: faith, law, philosophy and long travel all flourish; honour comes from abroad or from learning, and the beliefs are broad and humane',
      'honour, office and preferment: a respected public name, promotion that comes looking for you, and success carried by principle and patronage',
      'powerful, helpful friends: patrons who open doors, hopes generously met, and a circle that lifts',
      'fortune that works quietly: good done unseen, help arriving from nowhere at the worst moments, faith found in solitude, and over-trust the hidden tax'
    ],
    saturn: [
      'the start is slow and the manner grave: self-doubt walks in front, the frame runs lean and dry, and the life blooms late, but blooms solid',
      'money comes slowly and by labour: the fear of want runs out of proportion to the facts, and gain comes by land, patience and age; what is finally built, holds',
      'weight in the near world: duty or distance with siblings, a careful, sombre daily mind, and short journeys that are work rather than pleasure',
      'the family’s weight is carried: burdens from father, home and roots, property that binds as much as it shelters, and ground that is earned rather than given',
      'joy is rationed: children few, late or heavy with responsibility, caution where others play, and pleasure that has to be scheduled to happen at all',
      'the work is hard and unglamorous and it gets done: cold, chronic complaints tax the body, service weighs, and endurance turns out to be the actual skill',
      'marriage comes late, dutiful, or to someone older and graver: it endures where lighter matches fail, but it weighs, and enemies made here last',
      'the deep matters move slowly: legacies delayed, a long quiet fear of endings, and gain, eventually, by the dead, by land, and by patience with loss',
      'faith is serious business: doubting or orthodox, never casual; the long journeys are hard, and wisdom is earned by time and trial rather than granted',
      'the climb is slow and the fall, if it comes, is hard: authority won by endurance, a reputation for gravity, and a summit reached late but held',
      'few friends, but lasting ones, often older: hopes deferred and won by patience, and duty carried faithfully in the circle',
      'old sorrows keep their own room: confinement, hidden fears, enemies who work by time, and solitude that is first a sentence and then, slowly, a teacher'
    ]
  };
