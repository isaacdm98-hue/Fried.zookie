...
(async () => {
  ...
  for (const scr of SCREENS) {
    ...
    // NO synthetic taps: the seeded birth data skips the intro, and any tap lands on real UI
    // (it was selecting a planet on the chart, and drilling into a section on Learn)
